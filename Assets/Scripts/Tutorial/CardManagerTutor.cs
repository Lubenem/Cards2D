...
public class CardManagerTutor : MonoBehaviour
{
    //Instance so we can access it from all scripts
    public static CardManagerTutor instance;
    ...
    public void SelectCard(CardView card)
    {
        ...
        selectedCard.transform.SetParent(CardManagerTutor.instance.ParentHolder.transform);
    ...
    public void OnCardRelease()
    {
        ...
        if (SelectedCard != null)
        {
            ...
            {
                GetDummyCard().transform.SetParent(CardManagerTutor.instance.ParentHolder.transform);
